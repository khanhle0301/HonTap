...
using HonTap.Web.Common;
using HonTap.Web.Infrastructure.Extensions;
...
namespace HonTap.Web.Areas.Admin.Controllers
{
    public class PostCategoryController : BaseController
    {
        ...
        {
            var model = _postCategoryDao.ListAll();
            return View(model);
        }
        ...
        {
            ViewBag.ParentID = new SelectList(_postCategoryDao.ListAll(), "ID", "Name", selectedId);
        }
